...
float4 PixelShaderFunction(VertexShaderOutput input) : COLOR0
{
    ...
    float4 frame = float4(frameIndex % 6, floor(frameIndex / 6), 0.16667, 0.16667) * float4(imageSize.x, imageSize.y, imageSize.x, imageSize.y);
    ...
    return fireColor * color * dissolveOpacity * fireColor.r;
}
