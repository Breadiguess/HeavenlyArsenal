...
namespace HeavenlyArsenal.Content.NPCs.Bosses.FractalVulture
{
    ...
    public class FakeFlowerTile : ModTile, ICustomPlacementSound
    {
        ...
        /// </summary>
        public static NoxusBoss.Assets.LazyAsset<Texture2D> ActualTexture
        {
            get;
            private set;
        }
        ...
        {
            int centerTileX = i + FakeFlowerTile.Width / 2;
            int centerTileY = j + FakeFlowerTile.Height / 2;

            // Convert the center tile to world position
            Vector2 centerWorld = new Vector2(centerTileX, centerTileY).ToWorldCoordinates();
            centerWorld.Y -= 16f;
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            if (t.TileFrameX == (int)(Width * 0.5f) * 18 && t.TileFrameY == (Height - 1) * 18)
                ModContent.GetInstance<FakeFlowerTileRender>().AddPoint(new(i, j));
        }
