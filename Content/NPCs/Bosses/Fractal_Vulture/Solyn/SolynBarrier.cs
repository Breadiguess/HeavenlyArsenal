...
namespace HeavenlyArsenal.Content.NPCs.Bosses.Fractal_Vulture.Solyn
{
    internal class SolynBarrier : ModProjectile, IProjOwnedByBoss<BattleSolynBird>, IDrawsWithShader
    {
        ...
        public void DrawWithShader(SpriteBatch spriteBatch)
        {
            ...
            Main.spriteBatch.Draw(WhitePixel, drawPosition, null, Projectile.GetAlpha(Color.White), Projectile.rotation, WhitePixel.Size() * 0.5f, Projectile.Size/2 / WhitePixel.Size() * Projectile.scale, 0, 0f);
