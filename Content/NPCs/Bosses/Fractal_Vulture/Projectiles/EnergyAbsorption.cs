...
namespace HeavenlyArsenal.Content.NPCs.Bosses.Fractal_Vulture.Projectiles
{
    internal class EnergyAbsorption : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.Size = new Microsoft.Xna.Framework.Vector2(30, 30);
        ...
        public override void AI()
        {
           ...
           Projectile.velocity = Projectile.AngleTo(HomePos + Offset).ToRotationVector2().RotatedBy(MathF.Sin(Projectile.ai[0]++/10.1f + Projectile.whoAmI) * LumUtils.InverseLerp(0,60, Projectile.Distance(HomePos + Offset))) * 20f;
