...
namespace HeavenlyArsenal.Content.NPCs.Bosses.Fractal_Vulture.Projectiles
{
    internal class IntersectingComet : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float minDist = SegmentDistance(
                prev, cur,
                sister.LastPos, sister.Projectile.Center
            );
        ...
        private void Explode()
        {
            ...
            {
                Projectile b = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.DirectionFrom(Owner.NPC.Center), ModContent.ProjectileType<CometBackBlast>(), (int)(Owner.NPC.defDamage / 1.5f), 30);
            ...
            for (int i = 0; i < 3; i++)
            {
                Projectile a = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.AngleTo(Owner.NPC.Center).ToRotationVector2() * 10, ModContent.ProjectileType<EnergyAbsorption>(), 182, 0);
            ...
            SoundEngine.PlaySound(GennedAssets.Sounds.Avatar.PlanetoidExplosion with { PitchVariance = 0.2f, MaxInstances = 0 }, Projectile.Center).WithVolumeBoost(2);
            Projectile.Kill();
        }
        ...
        public Color TrailColor(float completionRatio)
        {
            ...
            Color crimson = new Color(255, 255, 255);
