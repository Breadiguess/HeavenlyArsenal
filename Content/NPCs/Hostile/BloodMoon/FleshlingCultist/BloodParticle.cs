...
{
    public static ParticlePool<BloodParticle> pool = new(500, GetNewParticle<BloodParticle>);
    ...
    public override void Update(ref ParticleRendererSettings settings)
    {
        ...
        for (var i = 1; i < trailPos.Length; i++)
        {
    ...
    public override void Draw(ref ParticleRendererSettings settings, SpriteBatch spritebatch)
    {
        ...
        for (var i = 0; i < trailPos.Length; i++)
        {
            ...
            var Rot = trailPos[i].AngleTo(Position);
            var Scale = new Vector2(1, 1) * 0.2f * (1 - i / (float)trailPos.Length) * 0.7f;
        ...
        var rot = Position.AngleTo(EndPosition);
