...
internal class Incomplete_gun : ModItem
{
    ...
    public override void HoldItem(Player player)
    {
        if (!fusionOut)
        {
            ...
            (
                ...
                0f,
                0f, // Velocity (set to 0 for stationary)
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        if (BossDownedSaveSystem.HasDefeated<NamelessDeityBoss>())
        {
            ...
            var specialTooltip = this.GetLocalizedValue("TooltipPostNamelessDeity");
        ...
        var tooltip = tooltips.FirstOrDefault(t => t.Name == "Tooltip1");
