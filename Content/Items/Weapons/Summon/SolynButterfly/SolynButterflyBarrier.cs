...
public class SolynButterflyBarrier : ModProjectile, IProjOwnedByBoss<BattleSolynBird>, IDrawsWithShader
{
    ...
    public void DrawWithShader(SpriteBatch spriteBatch)
    {
        ...
        Main.spriteBatch.Draw
            (WhitePixel, drawPosition, null, Projectile.GetAlpha(Color.White), Projectile.rotation, WhitePixel.Size() * 0.5f, Projectile.Size / WhitePixel.Size() * Projectile.scale, 0, 0f);
