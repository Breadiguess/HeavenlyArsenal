...
namespace HeavenlyArsenal.Content.Projectiles.Weapons.Melee
{
    public class CircularSawProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            switch (Mode)
            {
                default:
                    ...
                    {
                        if (Player.HeldItem.ModItem is CircularSaw rightClickItem)
                        {
                ...
                case 1:
                    ...
                    if (Main.myPlayer == Projectile.owner)
                    {
                        ...
                        else
                        {
                            ...
                            //adjusts the sawblade throw attack.
                            Projectile.velocity = Projectile.velocity.RotatedBy(0.04f * Projectile.direction) * 0.95f;
            ...
            if (Player.HeldItem.ModItem is CircularSaw item)
            {
                Projectile.rotation += MathF.Max(item.spin, 2f) * Projectile.direction * Player.gravDir;
